		...
		$(".detail")
				.click(
						function() {
							...
							let read = Number($(this).children("td").eq(4)
									.html()) + 1;
							let comment = $(this).children("td").eq(1)
									.children(".bg-secondary").text().length + 1;
							if (comment > 0) {
							...
							$
									.ajax({
										...
										success : function(data) {
											...
											name = name
													+ '<img class="" src="./img/edit.png"><img class="del" src="./img/delete.png">';
...
<body>
	...
	<header class="masthead">
		<div class="container">
			<div class="masthead-heading text-uppercase">NOTICE</div>
